 ...
 */
 ...
 describe('Given I am connected as an Admin', () => {
   ...
   describe('When I am on Dashboard page and I click 2 times on edit icon of a card', () => {
     test('Then bill Icon should Appear', () => {
   ...
   describe('When I am on Dashboard and there are no bills', () => {
     test('Then there should be no cards rendered', () => {
 ...
 describe('Given I am on Dashboard admin page and I clicked on a pending bill', () => {
   describe('When I click on accept button', () => {
     test('Clicked pending bill should be sent on Dashboard', () => {
       Object.defineProperty(window, 'localStorage', { value: localStorageMock })
       window.localStorage.setItem('user', JSON.stringify({
         type: 'Admin'
       }))
